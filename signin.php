...
<center>
  <div class="tab1">
    ...
    <form name="f2" method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
      ...
      <input  class="txt" type="text" name="name" id="name" value="<?php   if(isset($_POST['submit'])){ echo $_POST['name'];} ?>" required><br><br>
      ...
      if(isset($_POST['submit'])){
        ...
        if (!($a==$capt)) {
          //setcookie('user',$_SESSION['my_captcha'],time()+10);
          print "<script type=\"text/javascript\">";
          print "alert('enter valid captcha')";
          print "</script>";
          //echo "<h3>* Enter valid captcha.</h3>";
        }
        else{
        ...
        if(!$result){
          ...
          print "</script>";
      //  echo "Query execution not successfull";
        ...
        print "</script>";
          //echo "<h3>* Username and Password does not match.</h3>";
        }
        }
        mysqli_close($con);
        }
