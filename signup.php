...
<body>
  ...
  if(strlen($name)>20){
    ...
    print "</script>";
  //  echo "<h3>*Username is allowed with only 20 characters and should not contain spaces.</h3>";
  }
  else if (preg_match($a,$name)==false) {
    print "<script type=\"text/javascript\">";
    print "alert('Username should not contain spaces or special characters.')";
    print "</script>";
    //echo "<h3>*Username should not contain spaces or special characters.</h3>";
  }
  else if (strlen($pass1)<7||strlen($pass2)<7) {
    print "<script type=\"text/javascript\">";
    print "alert('Password should be atleast 7 characters.')";
    print "</script>";
    //echo "<h3>*Password should be atleast 7 characters.</h3>";
  }
  else if ($pass1!=$pass2) {
    print "<script type=\"text/javascript\">";
...
<div class="div2">
  ...
  <span style="font-size:15; padding-left:110px;">Already have an account? <br><a style="padding-left:625px;" href="signin.php">Sign In</a></span>
</div>
<center>
<div class="tab1">
    ...
    <form name="f1" method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
      ...
      <input  class="txt" type="text" name="name" id="name" value="<?php   if(isset($_POST['submit'])){ echo $_POST['name'];} ?>" required><br>
    <span class="inst"><b>Upto 20 characters,no spaces and special characters.</span><br><br>
      ...
      <input  class="txt" type="email" name="eid" id="eid"  value="<?php   if(isset($_POST['submit'])){ echo $_POST['eid'];} ?>" required><br>
